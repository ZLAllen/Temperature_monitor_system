 ...
 * cw input for the particular knob, ccw for counter clockwise turn. After reading
 * the input, the ISR will call the fsm to determne the next state.
 * Warnings             : none
 * Restrictions         : none
 * Algorithms           : none
 * References           : none
